...
int mdp4_overlay_set(struct fb_info *info, struct mdp_overlay *req)
{
	...
	/*
	* SEC_TEMP
	* Block underrun during display data to panel
	*/
#if defined(CONFIG_FB_MSM_LCDC_R69329_WVGA)
	return -ENODEV;
#endif
	...
	/*
	* This is working for filtering the video size 1200*700
	* that can not allocate writeback buffer
	*/
	if (req->src.width >= 1200 || req->src.height >= 700)
		return -EPERM;
#endif
