...
#define MSM_FB_OVERLAY0_WRITEBACK_SIZE roundup((320 * 480 * 3 * 2), 4096)
#else
...
static struct mms_ts_platform_data melfas_data = {
	...
	.config_fw_version = "M830_ME_0510",
...
static struct platform_device touchscreen_device_mms_ts = {
	.name = "mms_ts",
	.id = -1,
};
